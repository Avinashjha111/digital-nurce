...
const HEADER_TYPES = [
  ...
  { value: "text", label: "Text Header (Title / Heading)" },
        ...
        {state.success ? (
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2.5 rounded-lg border p-3 bg-muted/20">
                <div className="flex flex-col gap-1.5">
                  ...
                  <Select
                    value={headerType}
                    onValueChange={(v) =>
                      setHeaderType((v ?? "none") as "none" | "text" | "image" | "video" | "document")
                    }
                  >
                    <SelectTrigger className="w-full">
                      <SelectValue>
                        {() => HEADER_TYPES.find((h) => h.value === headerType)?.label ?? "None"}
                      </SelectValue>
                    </SelectTrigger>
                    <SelectContent>
                      {HEADER_TYPES.map((h) => (
                ...
                {headerType === "text" && (
                  <div className="flex flex-col gap-1.5 pt-1">
                    <Label htmlFor="header_text">Header text (max 60 characters)</Label>
                    <Input
                      id="header_text"
                      name="header_text"
                ...
                {(headerType === "image" || headerType === "video" || headerType === "document") && (
                  <div className="flex flex-col gap-1.5 pt-1">
                    <Label htmlFor="media_url">
                      {headerType === "image" && "Sample Image URL (optional)"}
                      {headerType === "video" && "Sample Video URL (optional)"}
                      {headerType === "document" && "Sample Document / PDF URL (optional)"}
                    </Label>
                    <Input
                      id="media_url"
                      name="media_url"
                    ...
                    <p className="text-[11px] text-muted-foreground">
                      Meta uses this sample to review your template. At send time, you can attach any real {headerType} file.
                    </p>
                  </div>
                )}
              </div>
              ...
              {/* Footer Text */}
              <div className="flex flex-col gap-1.5">
                <Label htmlFor="footer_text">Footer text (optional, max 60 characters)</Label>
                <Input
                  id="footer_text"
                  name="footer_text"
